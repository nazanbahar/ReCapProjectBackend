...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string ImageNotFound = "Image bulunmadı...";
        public static string FileDoesntExists = "Dosya mevcut değil...";
        public static string WrongFileType = "Yanlış dosya türü...";
